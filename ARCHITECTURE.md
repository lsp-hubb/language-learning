...
16. **翻译句子高亮** — 选中英文文本时，对应中文翻译句子自动高亮（粉色背景 `#fce4ec`），取消选中后高亮保持，新选中时更新
17. **批注工具栏开关** — 默认关闭浮动批注栏，点击标题栏 ▼ 手动开启；收起时标题栏显示内嵌高亮/下划线按钮（选中文本后点击可用）
...
| 提交 | 说明 |
|------|------|
| *待提交* | feat: 翻译句子高亮 + 批注栏开关/内嵌按钮 + SVG图标 + 左侧工具侧边栏 + 文章卡片纯色 + 文档更新 |
